...
type GetPersonResponse struct {
	...
	BooksRead string `protobuf:"bytes,1,opt,name=books_read,json=booksRead,proto3" json:"books_read,omitempty"`
}
...
func (x *GetPersonResponse) GetBooksRead() string {
	if x != nil {
		return x.BooksRead
	}
	return ""
...
var file_example_api_server_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x62, 0x6f, 0x6f, 0x6b, 0x73, 0x52, 0x65, 0x61, 0x64, 0x22,
