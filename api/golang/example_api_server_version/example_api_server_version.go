package example_api_server_version

const (
	// vvvv WARNING: DO NOT MODIFY THIS MANUALLY! IT WILL BE UPDATED DURING THE RELEASE PROCESS vvvvv
	// Used for libraries that consume this and need to know which version of the Docker image to pull
	ExampleAPIServerVersion = "0.3.2"
