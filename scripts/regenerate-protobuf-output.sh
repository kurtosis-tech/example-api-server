...
# This script regenerates bindings for the example API server in the various languages that this repo supports
...
RPC_BINDINGS_DIRNAME="example_api_server_rpc_api_bindings"

# =============================== MAIN LOGIC =======================================================
input_dirpath="${root_dirpath}/${API_DIRNAME}/${PROTOBUF_DIRNAME}"
