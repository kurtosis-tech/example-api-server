...
REL_FILEPATH_UPDATE_PATTERNS["api/golang/example_api_server_version/example_api_server_version.go"]="ExampleAPIServerVersion = \"%s\""
REL_FILEPATH_UPDATE_PATTERNS["api/typescript/src/example_api_server_version/example_api_server_version.ts"]="EXAMPLE_API_SERVER_VERSION: string = \"%s\""
