...
# Golang
CONSTANT_FILE_RELATIVE_FILEPATHS["golang"]="example_api_server_version/example_api_server_version.go"
CONSTANT_PATTERNS["golang"]="ExampleAPIServerVersion = \"%s\""

# Typescript
CONSTANT_FILE_RELATIVE_FILEPATHS["typescript"]="src/example_api_server_version/example_api_server_version.ts"
CONSTANT_PATTERNS["typescript"]="EXAMPLE_API_SERVER_VERSION: string = \"%s\""
